...
- Wersja na komputer (≥ 1024 px): boczna nawigacja `SideNav` w `App.tsx`, dolny pasek ukryty (`lg:hidden`), Dziś w dwóch kolumnach, Tydzień jako siatka 7 kolumn, Ustawienia w dwóch kolumnach; testy `e2e/desktop.spec.ts`.
