...
export function AccountSection() {
  ...
  async function send() {
    ...
    setMsg(error ?? 'Wysłałem link logowania – sprawdź pocztę i otwórz go na tym urządzeniu.')
  }
    ...
    <Card>
      ...
      {!auth.configured ? (
        ...
        <>
          ...
          <p className="mt-2 text-xs text-slate-500">Bez logowania wszystko działa lokalnie; po zalogowaniu dane synchronizują się między telefonem i komputerem.</p>
        </>
      )}
    </Card>
  )
